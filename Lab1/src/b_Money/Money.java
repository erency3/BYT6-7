...
public class Money implements Comparable {
	...
	public String toString() {
		...
		String rearranged = a.substring(0,a.length()-2)+ "."+ a.substring(a.length()-1,a.length());
		return rearranged + " " + currency.getName();
	}
	...
	public int compareTo(Object other) {
		Money a = (Money) other;
		double first=amount*currency.getRate();
		double second=a.getAmount()*a.getCurrency().getRate();
		if (second>first) {
			return -1;
		}
		if (first>second) {
